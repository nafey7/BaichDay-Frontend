...
function CustomerProfile() {
    ...
    return (
        <div className="container" style={{margin: "auto", boxShadow: '0px 7px 8px -4px rgb(0 0 0 / 20%), 0px 12px 17px 2px rgb(0 0 0 / 14%), 0px 5px 22px 4px rgb(0 0 0 / 12%)', height: "auto", backgroundColor: "#d9d9d9", position: "relative", width: "70%" }}>
            <div style={{
                display: 'grid',
