...
function Productlist() {
    ...
    React.useEffect(() => {
        axios.post('https://pacific-sands-58031.herokuapp.com/product/', {
            userID: userID
        })
                    ...
                    <Table stickyHeader sx={{ overflowY: 'scroll', backgroundColor: '#3c3d3f' }} aria-label="simple table">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell style={{ backgroundColor: '#1e1e1e', color: 'white', fontSize: '18px', fontWeight: "bold" }} align="center">Remove</TableCell>
                        ...
                        <TableBody>
                            {data.map((d) => (
                                <TableRow key={d.id}>
                                    ...
                                    <TableCell align="center" style={{ color: 'white', fontSize: '12px' }}></TableCell>
                                    <TableCell align="center" style={{ color: 'white', fontSize: '12px' }}></TableCell>
                                    <TableCell align="center" style={{ color: 'white', fontSize: '12px' }}><button className='btn btn-danger' style={{padding:'1.5% 10%',fontSize:'12px'}}>Remove</button></TableCell>
