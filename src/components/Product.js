...
function Product() {
  ...
  return (
    <div className="container" style={{boxShadow: '0px 7px 8px -4px rgb(0 0 0 / 20%), 0px 12px 17px 2px rgb(0 0 0 / 14%), 0px 5px 22px 4px rgb(0 0 0 / 12%)', backgroundColor: "#eaeaea", whiteSpace: 'nowrap', width: "100%", padding: '2rem' }}>
       <Modal
        open={open}
        onClose={handleClose}
